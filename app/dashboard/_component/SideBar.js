    ...
    <div className='shadow-md h-screen p-7'>
        ...
        <div className='mt-10'>
            ...
            <Button className="w-full">+ Upload PDF</Button>
              ...
              <Link href={'/dashboard'}>
            <div className=
            {`flex gap-2 items-center p-3 mt-5 hover:bg-slate-100 rounded-lg cursor-pointer
        ...
        <p className='txt-sm mt-1'>{fileList?.length} Out of 5 Pdf Completed</p>
        <p className='txt-sm text-gray-600 mt-1'>Upgrade to Upload More Pdf</p>
